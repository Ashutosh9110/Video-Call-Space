...
const HeroAnimation = () => {
  ...
  return (
    <>
      {/* SVG with clipPath - positioned off-screen */}
      <svg
      ...
      <div
        ref={containerRef}
        className="w-full h-screen min-h-screen flex items-center justify-center relative overflow-hidden z-10"
      >
        <div
          className="w-full h-screen relative flex justify-center items-center clip-path-[url(#clip-path1)] bg-white dark:bg-gray-900 overflow-hidden"
        ...
        >
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            className="absolute inset-0 w-full h-full z-0 block opacity-0"
          >
            <defs>
          ...
          <div
            ref={contentRef}
            className="relative z-10 text-white text-center font-sans opacity-0 max-w-full px-4"
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gray-900 dark:text-white">
              Hero Revealing Animation
            </h1>
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              Uses ScrollTrigger with pinning to reveal the hero section of a site and then keep scrolling.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Additional Sections */}
      <section className="panel-green min-h-screen bg-green-100 dark:bg-green-900 flex items-center justify-center flex-col text-gray-900 dark:text-white p-4">
        <h1 className="text-4xl font-bold mb-8">Some ScrollTrigger animations here</h1>
        <div className="flex flex-col md:flex-row gap-6 items-center justify-center">
          <div
            ref={(el) => el && (boxesRef.current[0] = el)}
            className="box w-32 h-32 bg-blue-500 rounded-xl"
          ></div>
          <div
            ref={(el) => el && (boxesRef.current[1] = el)}
            className="box w-32 h-32 bg-red-500 rounded-xl"
          ></div>
          <div
            ref={(el) => el && (boxesRef.current[2] = el)}
            className="box w-32 h-32 bg-purple-500 rounded-xl"
          ></div>
        </div>
      </section>

      <section className="min-h-screen bg-red-100 dark:bg-red-900 flex items-center justify-center text-gray-900 dark:text-white p-4">
